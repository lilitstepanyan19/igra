    ...
    def start(self):
        ...
        self.drop_img = [
            pygame.transform.scale(
                pygame.image.load("images/world_8/world_8_3/ball/ball_1.png").convert_alpha(), (70, 40)
            ),
            pygame.transform.scale(
                pygame.image.load("images/world_8/world_8_3/ball/ball_2.png").convert_alpha(), (110, 55)
            ),
            pygame.transform.scale(
                pygame.image.load("images/world_8/world_8_3/ball/ball_3.png").convert_alpha(), (100, 75)
            ),]
